...
class Settings extends Model {
    ...
    public function get() {
        ...
        if(!defined('PRODUCT_VERSION')) define('PRODUCT_VERSION', 1.2);
        if(!defined('PRODUCT_CODE')) define('PRODUCT_CODE', 1009);
        ...
        if (OFFLOAD_PROVIDER == 'local') {
            define('UPLOADS_FULL_URL',  SITE_URL . UPLOADS_URL_PATH);
        }else{
            define('UPLOADS_FULL_URL',  OFFLOAD_FULL_ENDPOINT . UPLOADS_URL_PATH);
        }
