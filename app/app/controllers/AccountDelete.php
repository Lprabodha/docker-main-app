    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            if(!password_verify($_POST['current_password'], $this->user->password)) {
                Alerts::add_field_error('current_password', l('account.account_delete.invalid_current_password'));
            }
            ...
            if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
                ...
                Alerts::add_success(l('global.account.account_delete.success_message'));
