...
class AdminLinks extends Controller {
    ...
    public function transfer() {
        ...
        if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
            ...
            /* Set a nice success message */
            Alerts::add_success(sprintf(l('admin.transfer_modal.success_message'), '<strong>' . input_clean($link->url) . '</strong>', '<strong>' . input_clean($current_user->email) . '</strong>', '<strong>' . input_clean($new_user->email) . '</strong>'));
