...
use BaconQrCode\Renderer\Module\HeartModule;
...
use BaconQrCode\Renderer\Eye\CircleCircleEye;
use BaconQrCode\Renderer\Eye\CircleSquareEye;
use BaconQrCode\Renderer\Eye\SquareCircleEye;
use BaconQrCode\Renderer\Module\ExtraRoundnessModule;
...
class Generator
{
    ...
    public function style(string $style, float $size = 0.5): self
    {
        ...
        if (! in_array($style, ['square', 'dot', 'round', 'extra_rounded','classy_rounded','diamond','heart'])) {
    ...
    public function getModule(): ModuleInterface
    {
        ...
        if ($this->style === 'extra_rounded') {
            return new RoundnessModule(0.5);
        }

        if ($this->style === 'heart') {
            return new HeartModule(0.8);
        }

        if ($this->style === 'diamond') {
            return new DiamondModule(0.9);
        }
