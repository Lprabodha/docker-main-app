...
<header class="header">
    <div class="container">
        <div class="d-flex">
            <div class="mr-3">
                <img src="./assets/images/logo.webp" class="img-fluid logo" alt="AltumCode logo" />
            </div>
                ...
                <section id="requirements" style="display: none">
                    ...
                    <table class="table mt-3">
                        ...
                        <tr>
                            ...
                            <td><?= PHP_VERSION ?></td>
                            <td>
                                <?php if(version_compare(PHP_VERSION, '7.4.0', '>=') && version_compare(PHP_VERSION, '8.1.0', '<')): ?>
                    ...
                    <table class="table mt-5">
                        ...
                        <tr>
                            <td>/uploads/qr_codes/logo</td>
                            <td><?= is_writable(ROOT . 'uploads/qr_codes/logo') ? 'Writable' : 'Not Writable' ?></td>
                            <td>
                                <?php if(is_writable(ROOT . 'uploads/qr_codes/logo')): ?>
                                    <img src="assets/svg/check-circle-solid.svg" class="img-fluid img-icon text-success" />
                                <?php else: ?>
                                    <img src="assets/svg/times-circle-solid.svg" class="img-fluid img-icon text-danger" />
                                    <?php $requirements = false; ?>
