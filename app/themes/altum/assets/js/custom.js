...
let data_type_handler = (type) => {
  document
    .querySelectorAll(`[data-type]:not([data-type="${type}"])`)
    .forEach((element) => {
...
// Google Data Tag push
const googleDataLayer = (event, data) => {
  ...
  switch (event) {
    ...
    case "registration":
      ...
      break;
    case "select_qr_step1_complete":

      window.dataLayer.push({
        event: "select_qr_step1_complete",
      ...
      break;
    case "qr_content_step2_complete":

      window.dataLayer.push({
        event: "qr_content_step2_complete",
        userId: data.userId != "" ? data.userId : null,
        user_type: data.user_type,
        method: data.method != "" ? data.method : null,
        entry_point: data.entry_point,
    ...
    case "qr_design_step3_complete":
      window.dataLayer.push({
        event: "qr_design_step3_complete",
        userId: data.userId != "" ? data.userId : null,
        user_type: data.user_type,
        method: data.method != "" ? data.method : null,
        entry_point: data.entry_point,
    ...
    case "qr_creation_process_complete":

      window.dataLayer.push({
        event: "qr_creation_process_complete",
        userId: data.userId != "" ? data.userId : null,
        user_type: data.user_type,
        method: data.method != "" ? data.method : null,
        entry_point: data.entry_point,
      ...
      break;
    case "upgrade_account_start":

      window.dataLayer.push({
        event: "upgrade_account_start",
        userId: data.userId,
        user_type: data.user_type,
        method: data.method,
        entry_point: data.entry_point,        
    ...
    case "purchase":
      ...
      window.dataLayer.push({
        ...
        ecommerce: {
          transaction_id: data.transaction_id,
        value: parseFloat(data.plan_value),
          ...
          items: [{
            ...
            price: parseFloat(data.plan_value),
            quantity: 1
          }]
        }
...
let userFunnle = (entery_point) => {

  var onboarding_funnel;

  switch (entery_point) {
    case '1':
      onboarding_funnel = 'Signup';
      break;
    case '2':
      onboarding_funnel = 'NSF';
      break;
    case '3':
      onboarding_funnel = 'DPF';
      break;

    default:
      onboarding_funnel = 'Signin';
  }

  return onboarding_funnel;
};
...
function getLanguageName(code) {
  ...
  if (languageCodes.hasOwnProperty(code)) {
