    ...
    <div class="row">
                ...
                <div class="card-body">
                    <form action="" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control brr <?= \Altum\Alerts::has_field_errors('name') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->name ?>" maxlength="64" required="required" />
                        ...
                        <div class="form-group">
                            ...
                            <select id="project_id" name="project_id" class="form-control brr">
                        ...
                        <div class="form-group" style="display:none ;">
                            ...
                            <select id="type" name="type" class="form-control brr">
                        ...
                        <div>
                            <div class="form-group" data-type="text">
                                ...
                                <textarea id="text" name="text" class="form-control brr <?= \Altum\Alerts::has_field_errors('text') ? 'is-invalid' : null ?>" maxlength="<?= $data->qr_code_settings['type']['text']['max_length'] ?>" required="required" data-reload-qr-code><?= $data->qr_code->settings->text ?? null ?></textarea>
                        ...
                        <div>
                            <div class="form-group" data-type="url" data-url>
                                ...
                                <input type="url" id="url" name="url" class="form-control brr <?= \Altum\Alerts::has_field_errors('url') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->url ?? null ?>" maxlength="<?= $data->qr_code_settings['type']['url']['max_length'] ?>" required="required" data-reload-qr-code />
                            ...
                            <div class="form-group" data-type="url" data-link-id>
                                ...
                                <select id="link_id" name="link_id" class="form-control" disabled="disabled" data-is-disabled="true" data-reload-qr-code>
                                    <?php foreach ($data->links as $row) : ?>
                                        <option value="<?= $row->link_id ?>" <?= ($data->qr_code->link_id ?? null) == $row->link_id ? 'selected="selected"' : null ?>><?= $row->full_url ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>

                            <div class="form-group" data-type="url" style="display:none ;">
                        ...
                        <div>
                            <div class="form-group" data-type="whatsapp">
                                ...
                                <input type="text" id="whatsapp" name="whatsapp" class="form-control brr <?= \Altum\Alerts::has_field_errors('whatsapp') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->whatsapp ?? null ?>" maxlength="<?= $data->qr_code_settings['type']['whatsapp']['max_length'] ?>" required="required" data-reload-qr-code />
                            ...
                            <div class="form-group" data-type="whatsapp">
                                ...
                                <textarea id="whatsapp_body" name="whatsapp_body" class="form-control brr <?= \Altum\Alerts::has_field_errors('whatsapp_body') ? 'is-invalid' : null ?>" maxlength="<?= $data->qr_code_settings['type']['whatsapp']['body']['max_length'] ?>" data-reload-qr-code><?= $data->qr_code->settings->whatsapp_body ?? null ?></textarea>
                        ...
                        <div>
                            <div class="form-group" data-type="event">
                                <label for="event"><i class="fa fa-fw fa-signature fa-sm mr-1"></i> <?= l('qr_codes.input.event') ?> ff</label>
                        ...
                        <button class="btn btn-block btn-gray-200 my-4 cclr" type="button" data-toggle="collapse" data-target="#colors_container" aria-expanded="false" aria-controls="colors_container">
                        ...
                        <div class="collapse" id="colors_container">
                            <div class="form-group">
                                ...
                                <div class="row btn-group-toggle" data-toggle="buttons">
                                    <div class="col-6">
                                        <label class="btn btn-light btn-block cclr <?= $data->qr_code->settings->style == 'square' ? 'active"' : null ?>">
                                    ...
                                    <div class="col-6">
                                        <label class="btn btn-light btn-block cclr <?= $data->qr_code->settings->style == 'dot' ? 'active' : null ?>">
                                    ...
                                    <div class="col-6">
                                        <label class="btn btn-light btn-block cclr <?= $data->qr_code->settings->style == 'round' ? 'active' : null ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row btn-group-toggle" data-toggle="buttons">
                                    <div class="col-6">
                                        <label class="btn btn-light btn-block cclr <?= $data->qr_code->settings->foreground_type == 'color' ? 'active"' : null ?>">
                                    ...
                                    <div class="col-6">
                                        <label class="btn btn-light btn-block cclr <?= $data->qr_code->settings->foreground_type == 'gradient' ? 'active' : null ?>">
                            ...
                            <div class="form-group" data-foreground-type="color">
                                ...
                                <input type="color" id="foreground_color" name="foreground_color" class="form-control brr <?= \Altum\Alerts::has_field_errors('foreground_color') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->foreground_color ?? '#000000' ?>" data-reload-qr-code />
                            ...
                            <div class="form-group" data-foreground-type="gradient">
                                ...
                                <input type="color" id="foreground_gradient_one" name="foreground_gradient_one" class="form-control brr <?= \Altum\Alerts::has_field_errors('foreground_gradient_one') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->foreground_gradient_one ?? '#000000' ?>" data-reload-qr-code />
                            ...
                            <div class="form-group" data-foreground-type="gradient">
                                ...
                                <input type="color" id="foreground_gradient_two" name="foreground_gradient_two" class="form-control brr <?= \Altum\Alerts::has_field_errors('foreground_gradient_two') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->foreground_gradient_two ?? '#000000' ?>" data-reload-qr-code />
                            ...
                            <div class="form-group">
                                ...
                                <input type="color" id="background_color" name="background_color" class="form-control brr <?= \Altum\Alerts::has_field_errors('background_color') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->background_color ?? '#ffffff' ?>" data-reload-qr-code />
                            ...
                            <div class="form-group">
                                ...
                                <input id="background_color_transparency" type="range" min="0" max="100" step="10" name="background_color_transparency" value="<?= $data->qr_code->background_color_transparency ?? 0 ?>" class="form-control brr <?= \Altum\Alerts::has_field_errors('background_color_transparency') ? 'is-invalid' : null ?>" data-reload-qr-code />
                            ...
                            <div class="form-group">
                                ...
                                <select id="custom_eyes_color" name="custom_eyes_color" class="form-control brr" data-reload-qr-code>
                            ...
                            <div class="form-group" data-custom-eyes-color="1">
                                ...
                                <input type="color" id="eyes_inner_color" name="eyes_inner_color" class="form-control brr <?= \Altum\Alerts::has_field_errors('eyes_inner_color') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->eyes_inner_color ?? '#000000' ?>" data-reload-qr-code />
                                <?= \Altum\Alerts::output_field_error('eyes_inner_color') ?>
                            </div>

                            <div class="form-group" data-custom-eyes-color="1">
                                <label for="eyes_outer_color"><?= l('qr_codes.input.eyes_outer_color') ?></label>
                                <input type="color" id="eyes_outer_color" name="eyes_outer_color" class="form-control brr <?= \Altum\Alerts::has_field_errors('eyes_outer_color') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->eyes_outer_color ?? '#000000' ?>" data-reload-qr-code />
                                <?= \Altum\Alerts::output_field_error('eyes_outer_color') ?>
                            </div>
                        </div>

                        <button class="btn btn-block btn-gray-200 my-4 cclr" type="button" data-toggle="collapse" data-target="#branding_container" aria-expanded="false" aria-controls="branding_container">
                        ...
                        <div class="collapse" id="branding_container">
                            <div class="form-group">
                                ...
                                <?php if (!empty($data->qr_code->qr_code_logo)) : ?>
                                    <input type="hidden" name="qr_code_logo" value="<?= UPLOADS_FULL_URL . 'qr_codes/logo/' . $data->qr_code->qr_code_logo ?>" />
                                    <div class="m-1">
                                        <img src="<?= UPLOADS_FULL_URL . 'qr_codes/logo/' . $data->qr_code->qr_code_logo ?>" class="img-fluid" style="max-height: 2.5rem;height: 2.5rem;" />
                                    </div>
                                ...
                                <?php endif ?>
                                <input id="qr_code_logo" type="file" name="qr_code_logo" accept="<?= \Altum\Uploads::get_whitelisted_file_extensions_accept('qr_codes/logo') ?>" class="form-control-file altum-file-input brr" data-reload-qr-code />
                            ...
                            <div class="form-group">
                                ...
                                <input id="qr_code_logo_size" type="range" min="5" max="35" name="qr_code_logo_size" value="<?= $data->qr_code->qr_code_logo_size ?? 25 ?>" class="form-control brr <?= \Altum\Alerts::has_field_errors('qr_code_logo_size') ? 'is-invalid' : null ?>" data-reload-qr-code />
                                <?= \Altum\Alerts::output_field_error('qr_code_logo_size') ?>
                            </div>
                        </div>

                        <button class="btn btn-block btn-gray-200 my-4 cclr" type="button" data-toggle="collapse" data-target="#options_container" aria-expanded="false" aria-controls="options_container">
                        ...
                        <div class="collapse" id="options_container">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input id="size" type="number" min="50" max="2000" name="size" class="form-control brr <?= \Altum\Alerts::has_field_errors('size') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->size ?>" data-reload-qr-code />
                                    <div class="input-group-append">
                                        <span class="input-group-text brr">px</span>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="margin" type="number" min="0" max="25" name="margin" class="form-control brr <?= \Altum\Alerts::has_field_errors('margin') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->margin ?>" data-reload-qr-code />
                                <?= \Altum\Alerts::output_field_error('margin') ?>
                            </div>

                            <div class="form-group">
                                <label for="ecc"><i class="fa fa-fw fa-check fa-sm mr-1"></i> <?= l('qr_codes.input.ecc') ?></label>
                                <select id="ecc" name="ecc" class="form-control brr" data-reload-qr-code>
                        ...
                        <button type="submit" name="submit" class="btn btn-block btn-primary mt-4 cclrf"><?= l('global.update') ?></button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-xl-6">
            <div class="mb-4">
                <div class="card borr">
                    <div class="card-body">
                        <img id="qr_code" src="<?= UPLOADS_FULL_URL . 'qr_codes/logo/' . $data->qr_code->qr_code ?>" class="img-fluid qr-code" loading="lazy" />
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-4 d-print-none">
                ...
                <div class="col-12 col-lg-6 mb-3 mb-lg-0 dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="<?= UPLOADS_FULL_URL . 'qr_codes/logo/' . $data->qr_code->qr_code ?>" id="download_svg" class="dropdown-item" download="<?= get_slug($data->qr_code->name) . '.svg' ?>"><?= sprintf(l('global.download_as'), 'SVG') ?></a>
