    ...
    <div class="overflow-auto flex-grow-1">
        <ul class="app-sidebar-links">
            ...
            <li class="<?= \Altum\Routing\Router::$controller == 'Qr' ? 'active' : null ?>">
                <a href="<?= url('qr/') ?>"><i class="fa fa-fw fa-sm fa-plus-circle mr-2"></i> <?= l('qr_menu') ?></a>
            </li>
            ...
            <li class="<?= \Altum\Routing\Router::$controller == 'My-Account' ? 'active' : null ?>">
                <a href="<?= url('account') ?>"><i class="fa fa-fw fa-sm fa-user mr-2"></i> <?= l('account.menu') ?></a>
            </li>

            <li class="<?= \Altum\Routing\Router::$controller == 'Billing' ? 'active' : null ?>">
                <a href="<?= url('billing') ?>"><i class="fa fa-fw fa-sm fa-credit-card mr-2"></i> <?= l('billing.menu') ?></a>
            </li>
            ...
            <li class="<?= \Altum\Routing\Router::$controller == 'Projects' ? 'active' : null ?>">
                <a href="<?= url('projects') ?>"><i class="fa fa-fw fa-sm fa-folder mr-2"></i> <?= l('projects.menu') ?></a>
            </li>
