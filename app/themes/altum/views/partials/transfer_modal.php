        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <span class="d-none" id="<?= $data->name . '_transfer_modal_subheader_hidden' ?>">
                    <?= $data->has_dynamic_resource_name ? l('admin.transfer_modal.subheader1') : l('admin.transfer_modal.subheader2') ?>
                </span>
                ...
                <form name="<?= $data->name . '_transfer_modal_form' ?>" method="post" action="" role="form">
                    ...
                    <div class="form-group">
                        <label for="email"><i class="fas fa-fw fa-sm fa-envelope text-muted mr-1"></i> <?= l('admin.transfer_modal.email') ?></label>
                        <input type="text" id="email" name="email" class="form-control" maxlength="320" placeholder="<?= l('admin.transfer_modal.email_placeholder') ?>" required="required" />
                    </div>
