...
<body text="#3f3d56" link="#3f3d56" yahoo="fix" style="">
    <table cellspacing="0" cellpadding="0" border="0" role="presentation" class="nl2go-body-table" width="100%" style="width: 100%; background-color: #EFF2F7;">

        <tr>
            <td align="center" class="r3-c">
                <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="600" class="r4-o" style="table-layout: fixed; width: 700px;">
                    <tr style="background-color: #ffffff;">
                        <td valign="top" class="" style="padding: 30px 45px;">
                                                        ...
                                                        <tr>
                                                            <th width="100%" valign="top" class="r6-c" style="font-weight: normal;">
                                                                <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r1-o" style="table-layout: fixed; width: 100%;"><!-- -->
                                                                    <tr>
                                                                        <td valign="top" class="r7-i" style="padding-left: 0px; padding-right: 15px;">
                                                                            <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                                                                <tr>
                                                                                    <td class="r11-c" align="center">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="" style="font-size: 0px; line-height: 0px;">
                                                                                                    <a style="text-decoration: none;" href="<?php echo url('login?redirect=qr-codes')  ?>">
                                                                                                        <img src="https://img.mailinblue.com/5806618/images/content_library/original/646288c6a3fb016409558f47.png" width="234" border="0" class="" style="display: block; width: 80%;">
                                                                                                    </a>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="left" valign="top" class="r19-i nl2go-default-textstyle" style="color: #3f3d56; font-family: Montserrat,Arial,Helvetica,sans-serif; font-size: 20px; word-break: break-word; line-height: 1.3; text-align: left;">
                                                                                                    <div style="margin-bottom: 25px;">
                                                                                                        <h2 class="default-heading2" style="margin: 0; color: #434343; font-family: Montserrat,Arial,Helvetica,sans-serif; font-size: 32px; word-break: break-word;">
                                                                                                            <?= l('emails_verification_code.header', $data->language) ?>
                                                                                                        </h2>
                                                                                                    </div>
                                                                                                </td>
                                                                                            </tr>
                                                                                        ...
                                                                                        <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r15-o" style="table-layout: fixed; width: 100%;">
                                                                                            <tr>
                                                                                                <td align="left" valign="top" class="r19-i nl2go-default-textstyle" style="color: #3f3d56; font-family: Montserrat,Arial,Helvetica,sans-serif; font-size: 20px; line-height: 1.4; word-break: break-word; text-align: left;">
                                                                                                    <div>
                                                                                                        <h3 class="default-heading3" style="margin: 0; color: #434343; font-family: Montserrat,Arial,Helvetica,sans-serif; font-size: 21px; word-break: break-word;">
                                                                                                            <?= l('emails_verification_code.title', $data->language) ?></h3>
                                                                                                    </div>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td align="left" valign="top">
                                                                                                    <div style="padding: 15px 0px; padding-bottom: 23px;">
                                                                                                        <p style="margin: 0; color: #434343; font-family: Montserrat,Arial,Helvetica,sans-serif; font-size: 15px; word-break: break-word;">
                                                                                                            <?= l('emails_verification_code.content_1', $data->language) ?> -
                                                                                                            <br> <?= l('emails_verification_code.content_2', $data->language) ?> :
                                                                                                        </p>
                                                                                                    </div>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr style="background-color: #EFF2F7; border-radius: 2px;">
                                                                                                <td align="center" valign="top" style="border-radius: 5px;">
                                                                                                    <div>
                                                                                                        <p style="font-family: Montserrat,Arial,Helvetica,sans-serif;font-weight: 600;font-size: 20px;padding: 15px;letter-spacing: 7px;color: #27c056;">
                                                                                                            <?= $data->code ?></p>
                                                                                                    </div>
                                                                                                </td>
                                                                                            </tr>
                                                                                                    ...
                                                                                                    <div>
                                                                                                        <p style="margin: 0;">
                                                                                                            <span style="font-size: 16px;">
                                                                                                                <?= l('emails_verification_code.content_3', $data->language) ?>
                                                                                                            </span>
                                                                                                        </p>
                                                                                                    </div>
                                                                                                </td>
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                <tr>
                                    <td class="r3-c" align="center">
                                        <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="600" class="r4-o" style="table-layout: fixed; width: 600px;border: none;"><!-- -->
                                            <tr>
                                                <td class="r34-i" style="padding-bottom: 55px; padding-left: 65px; padding-right: 40px; padding-top: 40px;">
                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                                        <tr>
                                                            <th width="100%" valign="top" class="r6-c" style="font-weight: normal;">
                                                                        ...
                                                                        <td valign="top" class="r7-i" style="padding-left: 10px; padding-right: 10px;">
                                                                            <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                                                                <tr>
                                                                                    <td class="r11-c" align="center">
                                                                                        <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r9-o" style="table-layout: fixed; width: 100%;">
                                                                                            <tbody align="center" style="display: block;">
                                                                                                <tr>
