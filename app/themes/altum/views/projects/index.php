    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-xl-auto d-flex">
            <div>
                ...
                <?php else : ?>
                    <a href="<?= url('project-create') ?>" class="btn btn-primary cclr"><i class="fa fa-fw fa-sm fa-plus"></i> <?= l('projects.create') ?></a>
                <?php endif ?>
            </div>
        ...
        <div class="card borr">
            <div class="card-body">
                <div class="d-flex flex-column align-items-center justify-content-center py-3">
                    <img src="<?= ASSETS_FULL_URL . 'images/no_rows.svg' ?>" class="col-10 col-md-7 col-lg-4 mb-3 img-fluid no-rows-img" alt="<?= l('projects.no_data') ?>" />
