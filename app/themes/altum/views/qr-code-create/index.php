            ...
            <div class="card borr">
                <div class="card-body">
                    <form action="" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="qr_frame_path" id="qr_frame_path" />
                        <input type="hidden" name="qr_frame_id" id="qr_frame_id" />

                        <div class="notification-container"></div>

                        <div class="form-group">
                            <label for="name"><i class="fa fa-fw fa-signature fa-sm mr-1"></i> <?= l('qr_codes.input.name') ?></label>
                            <input type="text" id="name" name="name" class="form-control brr <?= \Altum\Alerts::has_field_errors('name') ? 'is-invalid' : null ?>" value="<?= $data->values['name'] ?? null ?>" maxlength="64" required="required" />
                        ...
                        <div>
                            <div class="form-group" data-type="text">
                                ...
                                <textarea id="text" name="text" class="form-control brr <?= \Altum\Alerts::has_field_errors('text') ? 'is-invalid' : null ?>" maxlength="<?= $data->qr_code_settings['type']['text']['max_length'] ?>" required="required" data-reload-qr-code><?= $data->values['settings']['text'] ?? null ?></textarea>
                        ...
                        <div>
                            <div class="form-group" data-type="url" data-url>
                                ...
                                <input type="url" id="url" name="url" class="form-control brr <?= \Altum\Alerts::has_field_errors('url') ? 'is-invalid' : null ?>" value="<?= $data->values['settings']['url'] ?? null ?>" maxlength="<?= $data->qr_code_settings['type']['url']['max_length'] ?>" required="required" data-reload-qr-code />
                            ...
                            <div class="form-group" data-type="url" data-link-id>
                                ...
                                <select id="link_id" name="link_id" class="form-control brr" required="required" data-reload-qr-code>
                        ...
                        <div class="collapse" id="colors_container">
                            <div class="form-group">
                                ...
                                <div class="row btn-group-toggle" data-toggle="buttons">
                                    <div class="col-6">
                                        <label class="btn btn-light btn-block cclr <?= ($data->values['settings']['style'] ?? null) == 'square' ? 'active"' : null ?>">
                                    ...
                                    <div class="col-6">
                                        <label class="btn btn-light btn-block cclr <?= ($data->values['settings']['style'] ?? null) == 'dot' ? 'active' : null ?>">
                                    ...
                                    <div class="col-6">
                                        <label class="btn btn-light btn-block cclr <?= ($data->values['settings']['style'] ?? null) == 'round' ? 'active' : null ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row btn-group-toggle" data-toggle="buttons">
                                    <div class="col-6">
                                        <label class="btn btn-light btn-block cclr <?= ($data->values['settings']['foreground_type'] ?? null) == 'color' ? 'active"' : null ?>">
                                    ...
                                    <div class="col-6">
                                        <label class="btn btn-light btn-block cclr <?= ($data->values['settings']['foreground_type'] ?? null) == 'gradient' ? 'active' : null ?>">
                            ...
                            <div class="form-group" data-foreground-type="color">
                                ...
                                <input type="color" id="foreground_color" name="foreground_color" class="form-control brr <?= \Altum\Alerts::has_field_errors('foreground_color') ? 'is-invalid' : null ?>" value="<?= $data->values['settings']['foreground_color'] ?? '#000000' ?>" data-reload-qr-code />
                            ...
                            <div class="form-group" data-foreground-type="gradient">
                                ...
                                <select id="foreground_gradient_style" name="foreground_gradient_style" class="form-control brr" data-reload-qr-code>
                            ...
                            <div class="form-group" data-foreground-type="gradient">
                                ...
                                <input type="color" id="foreground_gradient_one" name="foreground_gradient_one" class="form-control brr <?= \Altum\Alerts::has_field_errors('foreground_gradient_one') ? 'is-invalid' : null ?>" value="<?= $data->values['settings']['foreground_gradient_one'] ?? '#000000' ?>" data-reload-qr-code />
                            ...
                            <div class="form-group" data-foreground-type="gradient">
                                ...
                                <input type="color" id="foreground_gradient_two" name="foreground_gradient_two" class="form-control brr <?= \Altum\Alerts::has_field_errors('foreground_gradient_two') ? 'is-invalid' : null ?>" value="<?= $data->values['settings']['foreground_gradient_two'] ?? '#000000' ?>" data-reload-qr-code />
                            ...
                            <div class="form-group">
                                ...
                                <input type="color" id="background_color" name="background_color" class="form-control brr <?= \Altum\Alerts::has_field_errors('background_color') ? 'is-invalid' : null ?>" value="<?= $data->values['settings']['background_color'] ?? '#ffffff' ?>" data-reload-qr-code />
                            ...
                            <div class="form-group" data-custom-eyes-color="1">
                                ...
                                <input type="color" id="eyes_inner_color" name="eyes_inner_color" class="form-control brr <?= \Altum\Alerts::has_field_errors('eyes_inner_color') ? 'is-invalid' : null ?>" value="<?= $data->values['settings']['eyes_inner_color'] ?? '#000000' ?>" data-reload-qr-code />
                                <?= \Altum\Alerts::output_field_error('eyes_inner_color') ?>
                            </div>

                            <div class="form-group" data-custom-eyes-color="1">
                                <label for="eyes_outer_color"><?= l('qr_codes.input.eyes_outer_color') ?></label>
                                <input type="color" id="eyes_outer_color" name="eyes_outer_color" class="form-control brr <?= \Altum\Alerts::has_field_errors('eyes_outer_color') ? 'is-invalid' : null ?>" value="<?= $data->values['settings']['eyes_outer_color'] ?? '#000000' ?>" data-reload-qr-code />
                        ...
                        <div class="collapse" id="options_container">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input id="size" type="number" min="50" max="2000" name="size" class="form-control brr <?= \Altum\Alerts::has_field_errors('size') ? 'is-invalid' : null ?>" value="<?= $data->values['settings']['size'] ?? 500 ?>" data-reload-qr-code />
                            ...
                            <div class="form-group">
                                ...
                                <input id="margin" type="number" min="0" max="25" name="margin" class="form-control brr <?= \Altum\Alerts::has_field_errors('margin') ? 'is-invalid' : null ?>" value="<?= $data->values['settings']['margin'] ?? 0 ?>" data-reload-qr-code />
                        ...
                        <button type="submit" name="submit" class="btn btn-block btn-primary mt-4 cclrf"><?= l('global.create') ?></button>
                    </form>
                </div>
            </div>
        </div>
