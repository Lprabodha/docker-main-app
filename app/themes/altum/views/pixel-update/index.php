        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control brr" value="<?= $data->pixel->name ?>" required="required" />
                </div>

                <div class="form-group">
                    <label for="type"><i class="fa fa-fw fa-adjust fa-sm mr-1"></i> <?= l('pixels.input.type') ?></label>
                    <select id="type" name="type" class="form-control brr" required="required">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="pixel" name="pixel" class="form-control brr" value="<?= $data->pixel->pixel ?>" required="required" />
