...
<div class="container mt-3">
    ...
    $host = $url['host'] . (mb_strlen($url['path']) > 1 ? $url['path'] : null); ?>
        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control brr" value="<?= $data->project->name ?>" required="required" />
                </div>

                <div class="form-group">
                    <label for="color"><i class="fa fa-fw fa-palette fa-sm mr-1"></i> <?= l('projects.input.color') ?></label>
                    <input type="color" id="color" name="color" class="form-control brr" value="<?= $data->project->color ?>" required="required" />
