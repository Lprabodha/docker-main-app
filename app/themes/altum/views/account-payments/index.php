                ...
                <tbody>
                    ...
                    <?php foreach ($data->payments as $row) : ?>
                        ...
                        <tr>
                            ...
                            <td class="text-nowrap">
                                <div class="d-flex flex-column">
                                    <span><?= l('pay_custom_plan.' . $row->type . '_type') ?></span>
                                    <span class="text-muted"><?= l('pay_custom_plan.' . $row->processor) ?></span>
                                </div>
                            </td>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-column align-items-center justify-content-center py-3">
                    <img src="<?= ASSETS_FULL_URL . 'images/no_rows.svg' ?>" class="col-10 col-md-7 col-lg-4 mb-3 img-fluid no-rows-img" alt="<?= l('account_payments.payments.no_data') ?>" />
