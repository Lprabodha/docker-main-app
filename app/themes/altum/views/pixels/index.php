    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-xl-auto d-flex">
            <div>
                ...
                <?php else: ?>
                    <a href="<?= url('pixel-create') ?>" class="btn btn-primary cclr"><i class="fa fa-fw fa-sm fa-plus"></i> <?= l('pixels.create') ?></a>
                <?php endif ?>
            </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-right filters-dropdown borr">
                        ...
                        <form action="" method="get" role="form">
                            ...
                            <div class="form-group px-4">
                                ...
                                <select name="type" id="filters_type" class="form-control form-control-sm brr">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-column align-items-center justify-content-center py-3">
                    <img src="<?= ASSETS_FULL_URL . 'images/no_rows.svg' ?>" class="col-10 col-md-7 col-lg-4 mb-3 img-fluid no-rows-img" alt="<?= l('pixels.no_data') ?>" />
