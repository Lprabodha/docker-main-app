...
<div id="step2_form">
                ...
                <div class="form-group m-0">
                    ...
                    <div class="colorPaletteForm">
                        <div class="formcolorPalette active" id="formcolorPalette1">
                            <input type="color" name="" class="colorPalette" value="#527ac9" readonly />
                            <input type="color" name="" class="colorPalette" value="#7ec09f" readonly />
                        </div>
                        ...
                        <div class="form-group m-0">
                            ...
                            <div class="customColorPicker">
                                <label for="primaryColor">
                                    <input id="primaryColor" name="primaryColor" onchange="LoadPreview()" class="pickerField pickerFieldes" type="color" value="<?php echo (!empty($filledInput)) ? $filledInput['primaryColor'] : '#527ac9'; ?>" data-reload-qr-code /><span><?php echo (!empty($filledInput)) ? $filledInput['primaryColor'] : '#527ac9'; ?></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group m-0">
                            ...
                            <div class="customColorPicker">
                                <label for="SecondaryColor">
                                    <input id="SecondaryColor" name="SecondaryColor" onchange="LoadPreview()" class="pickerField pickerFields" type="color" value="<?php echo (!empty($filledInput)) ? $filledInput['SecondaryColor'] : '#7ec09f'; ?>" data-reload-qr-code /><span><?php echo (!empty($filledInput)) ? $filledInput['SecondaryColor'] : '#7ec09f'; ?></span>
                                </label>
                            </div>
                        </div>
                    </div>
        ...
        <div class="collapse show" id="acc_businessInfo">
            ...
            <button type="button" class="upload-btn" onclick="LoadPreview(true)">Preview</button>
                ...
                <div class="welcome-screen mb-4">
                    <span style="display:flex;"><?= l('qr_codes.input.companyLogo') ?> </span>
                ...
                <div class="form-group">
                    <label for="company"> <?= l('qr_codes.input.company') ?> <span class="text-danger text-bold">*</span></label>
                    <input id="company" onchange="LoadPreview()" name="company" class="form-control" value="<?php echo (!empty($filledInput)) ? $filledInput['company'] : ''; ?>" placeholder="E.g.Company LLC" maxlength="<?= $data->qr_code_settings['type']['menu']['companyTitle']['max_length'] ?>" required="required" data-reload-qr-code input_validate />
                </div>
                <div class="form-group">
                    <label for="companyTitle">Title  <span class="text-danger text-bold">*</span></label>
                    <input id="companyTitle" onchange="LoadPreview()" name="companyTitle" class="form-control" value="<?php echo (!empty($filledInput)) ? $filledInput['companyTitle'] : ''; ?>" placeholder="E.g." maxlength="<?= $data->qr_code_settings['type']['menu']['companyDescription']['max_length'] ?>" required="required" data-reload-qr-code input_validate />
                </div>
                <div class="form-group">
                    <label for="companySubtitle">Subtitle <span class="text-danger text-bold">*</span></label>
                    <input id="companySubtitle" onchange="LoadPreview()" name="companySubtitle" class="form-control" value="<?php echo (!empty($filledInput)) ? $filledInput['companySubtitle'] : ''; ?>" placeholder="E.g." maxlength="<?= $data->qr_code_settings['type']['menu']['companyDescription']['max_length'] ?>" required="required" data-reload-qr-code input_validate />
                </div>
        ...
        <div class="collapse show" id="acc_openingHours">
            <div class="collapseInner p-0">
                <div class="form-group m-0">
                    ...
                    <div class="checkboxBorder d-sm-block1 px-0">
                        <div class="col-4 d-flex ml-3 my-4 align-items-center p-0">
                            <div class="roundCheckbox">
                                <input type="checkbox" id="checkboxMon" <?php echo (!empty($filledInput)) ? (($filledInput['Monday_From']) ? 'checked' : '') : ''; ?> />
                        ...
                        <div class="d-flex col px-0">
                            <div class="name col">
                                <input type="time" id="Monday_From" onchange="LoadPreview()" name="Monday_From" placeholder="From" value="<?php echo (!empty($filledInput)) ? $filledInput['Monday_From'] : ''; ?>" class="form-control Monday_From" <?php echo (!empty($filledInput)) ? (($filledInput['Monday_From']) ? '' : 'disabled') : 'disabled'; ?> data-reload-qr-code />

                            </div>
                            <div class="name col">
                                <input type="time" id="Monday_To" name="Monday_To" onchange="LoadPreview()" value="<?php echo (!empty($filledInput)) ? $filledInput['Monday_To'] : ''; ?>" placeholder="To" class="form-control Monday_To" <?php echo (!empty($filledInput)) ? (($filledInput['Monday_From']) ? '' : 'disabled') : 'disabled'; ?> data-reload-qr-code />
                    ...
                    <div class="checkboxBorder d-sm-block1 px-0">
                        <div class="col-4 d-flex ml-3 my-4 align-items-center p-0">
                            <div class="roundCheckbox">
                                <input type="checkbox" id="checkboxTue" <?php echo (!empty($filledInput)) ? (($filledInput['Tuesday_From']) ? 'checked' : '') : ''; ?> />
                        ...
                        <div class="d-flex col px-0">
                            <div class="name col">
                                <input type="time" id="Tuesday_From" onchange="LoadPreview()" name="Tuesday_From" placeholder="From" value="<?php echo (!empty($filledInput)) ? $filledInput['Tuesday_From'] : ''; ?>" class="form-control Tuesday_From" <?php echo (!empty($filledInput)) ? (($filledInput['Tuesday_From']) ? '' : 'disabled') : 'disabled'; ?> data-reload-qr-code />

                            </div>
                            <div class="name col">
                                <input type="time" id="Tuesday_To" name="Tuesday_To" onchange="LoadPreview()" value="<?php echo (!empty($filledInput)) ? $filledInput['Tuesday_To'] : ''; ?>" placeholder="To" class="form-control Tuesday_To" <?php echo (!empty($filledInput)) ? (($filledInput['Tuesday_From']) ? '' : 'disabled') : 'disabled'; ?> data-reload-qr-code />
                    ...
                    <div class="checkboxBorder d-sm-block1 px-0">
                        <div class="col-4 d-flex ml-3 my-4 align-items-center p-0">
                            <div class="roundCheckbox">
                                <input type="checkbox" id="checkboxWed" <?php echo (!empty($filledInput)) ? (($filledInput['Wednesday_From']) ? 'checked' : '') : ''; ?> />
                                <label class="m-0" for="checkboxWed"></label>
                            </div>
                            <label class="m-0">Wedesday</label>
                        </div>


                        <div class="d-flex col px-0">
                            <div class="name col">
                                <input type="time" id="Wednesday_From" onchange="LoadPreview()" name="Wednesday_From" placeholder="From" value="<?php echo (!empty($filledInput)) ? $filledInput['Wednesday_From'] : ''; ?>" class="form-control Wednesday_From" <?php echo (!empty($filledInput)) ? (($filledInput['Wednesday_From']) ? '' : 'disabled') : 'disabled'; ?> data-reload-qr-code />

                            </div>
                            <div class="name col">
                                <input type="time" id="Wednesday_To" name="Wednesday_To" onchange="LoadPreview()" value="<?php echo (!empty($filledInput)) ? $filledInput['Wednesday_To'] : ''; ?>" placeholder="To" class="form-control Wednesday_To" <?php echo (!empty($filledInput)) ? (($filledInput['Wednesday_From']) ? '' : 'disabled') : 'disabled'; ?> data-reload-qr-code />
                    ...
                    <div class="checkboxBorder d-sm-block1 px-0">
                        <div class="col-4 d-flex ml-3 my-4 align-items-center p-0">
                            <div class="roundCheckbox">
                                <input type="checkbox" id="checkboxThu" <?php echo (!empty($filledInput)) ? (($filledInput['Thursday_From']) ? 'checked' : '') : ''; ?> />
                        ...
                        <div class="d-flex col px-0">
                            <div class="name col">
                                <input type="time" id="Thursday_From" onchange="LoadPreview()" name="Thursday_From" placeholder="From" value="<?php echo (!empty($filledInput)) ? $filledInput['Thursday_From'] : ''; ?>" class="form-control Thursday_From" <?php echo (!empty($filledInput)) ? (($filledInput['Thursday_From']) ? '' : 'disabled') : 'disabled'; ?> data-reload-qr-code />

                            </div>
                            <div class="name col">
                                <input type="time" id="Thursday_To" name="Thursday_To" onchange="LoadPreview()" value="<?php echo (!empty($filledInput)) ? $filledInput['Thursday_To'] : ''; ?>" placeholder="To" class="form-control Thursday_To" <?php echo (!empty($filledInput)) ? (($filledInput['Thursday_From']) ? '' : 'disabled') : 'disabled'; ?> data-reload-qr-code />
                    ...
                    <div class="checkboxBorder d-sm-block1 px-0">
                        <div class="col-4 d-flex ml-3 my-4 align-items-center p-0">
                            <div class="roundCheckbox">
                                <input type="checkbox" id="checkboxFri" <?php echo (!empty($filledInput)) ? (($filledInput['Friday_From']) ? 'checked' : '') : ''; ?> />
                        ...
                        <div class="d-flex col px-0">
                            <div class="name col">
                                <input type="time" id="Friday_From" onchange="LoadPreview()" name="Friday_From" placeholder="From" value="<?php echo (!empty($filledInput)) ? $filledInput['Friday_From'] : ''; ?>" class="form-control Friday_From" <?php echo (!empty($filledInput)) ? (($filledInput['Friday_From']) ? '' : 'disabled') : 'disabled'; ?> data-reload-qr-code />

                            </div>
                            <div class="name col">
                                <input type="time" id="Friday_To" name="Friday_To" onchange="LoadPreview()" value="<?php echo (!empty($filledInput)) ? $filledInput['Friday_To'] : ''; ?>" placeholder="To" class="form-control Friday_To" <?php echo (!empty($filledInput)) ? (($filledInput['Friday_From']) ? '' : 'disabled') : 'disabled'; ?> data-reload-qr-code />
                    ...
                    <div class="checkboxBorder d-sm-block1 px-0">
                        <div class="col-4 d-flex ml-3 my-4 align-items-center p-0">
                            <div class="roundCheckbox">
                                <input type="checkbox" id="checkboxSat" <?php echo (!empty($filledInput)) ? (($filledInput['Saturday_From']) ? 'checked' : '') : ''; ?> />
                        ...
                        <div class="d-flex col px-0">
                            <div class="name col">
                                <input type="time" id="Saturday_From" onchange="LoadPreview()" name="Saturday_From" placeholder="From" value="<?php echo (!empty($filledInput)) ? $filledInput['Saturday_From'] : ''; ?>" class="form-control Saturday_From" <?php echo (!empty($filledInput)) ? (($filledInput['Saturday_From']) ? '' : 'disabled') : 'disabled'; ?> data-reload-qr-code />

                            </div>
                            <div class="name col">
                                <input type="time" id="Saturday_To" name="Saturday_To" onchange="LoadPreview()" value="<?php echo (!empty($filledInput)) ? $filledInput['Saturday_To'] : ''; ?>" placeholder="To" class="form-control Saturday_To" <?php echo (!empty($filledInput)) ? (($filledInput['Saturday_From']) ? '' : 'disabled') : 'disabled'; ?> data-reload-qr-code />
                    ...
                    <div class="checkboxBorder d-sm-block1 px-0">
                        <div class="col-4 d-flex ml-3 my-4 align-items-center p-0">
                            <div class="roundCheckbox">
                                <input type="checkbox" id="checkboxSun" <?php echo (!empty($filledInput)) ? (($filledInput['Sunday_From']) ? 'checked' : '') : ''; ?> />
                        ...
                        <div class="d-flex col px-0">
                            <div class="name col">
                                <input type="   " id="Sunday_From" onchange="LoadPreview()" name="Sunday_From" placeholder="From" value="<?php echo (!empty($filledInput)) ? $filledInput['Sunday_From'] : ''; ?>" class="form-control Sunday_From" <?php echo (!empty($filledInput)) ? (($filledInput['Sunday_From']) ? '' : 'disabled') : 'disabled'; ?> data-reload-qr-code />

                            </div>
                            <div class="name col">
                                <input type="time" id="Sunday_To" name="Sunday_To" onchange="LoadPreview()" value="<?php echo (!empty($filledInput)) ? $filledInput['Sunday_To'] : ''; ?>" placeholder="To" class="form-control Sunday_To" <?php echo (!empty($filledInput)) ? (($filledInput['Sunday_From']) ? '' : 'disabled') : 'disabled'; ?> data-reload-qr-code />
                ...
                <div class="form-group m-0">
                    <ul class="ks-cboxtags facilitiesIcon">
                        <li data-toggle="" data-placement="bottom" title="ficon">
                            <input type="checkbox" id="ficon" name="ficon" <?php echo (!empty($filledInput)) ? (($filledInput['ficon']) ? 'checked' : '') : ''; ?> data-reload-qr-code>
                        ...
                        <li data-toggle="" data-placement="bottom" title="ficon1">
                            <input type="checkbox" id="ficon1" name="ficon1" <?php echo (!empty($filledInput)) ? (($filledInput['ficon1']) ? 'checked' : '') : ''; ?> data-reload-qr-code>
                        ...
                        <li data-toggle="" data-placement="bottom" title="ficon2">
                            <input type="checkbox" id="ficon2" name="ficon2" <?php echo (!empty($filledInput)) ? (($filledInput['ficon2']) ? 'checked' : '') : ''; ?> data-reload-qr-code>
                        ...
                        <li data-toggle="" data-placement="bottom" title="ficon3">
                            <input type="checkbox" id="ficon3" name="ficon3" <?php echo (!empty($filledInput)) ? (($filledInput['ficon3']) ? 'checked' : '') : ''; ?> data-reload-qr-code>
                        ...
                        <li data-toggle="" data-placement="bottom" title="ficon4">
                            <input type="checkbox" id="ficon4" name="ficon4" <?php echo (!empty($filledInput)) ? (($filledInput['ficon4']) ? 'checked' : '') : ''; ?> data-reload-qr-code>
                        ...
                        <li data-toggle="" data-placement="bottom" title="ficon5">
                            <input type="checkbox" id="ficon5" name="ficon5" <?php echo (!empty($filledInput)) ? (($filledInput['ficon5']) ? 'checked' : '') : ''; ?> data-reload-qr-code>
                        ...
                        <li data-toggle="" data-placement="bottom" title="ficon6">
                            <input type="checkbox" id="ficon6" name="ficon6" <?php echo (!empty($filledInput)) ? (($filledInput['ficon6']) ? 'checked' : '') : ''; ?> data-reload-qr-code>
                        ...
                        <li data-toggle="" data-placement="bottom" title="ficon7">
                            <input type="checkbox" id="ficon7" name="ficon7" <?php echo (!empty($filledInput)) ? (($filledInput['ficon7']) ? 'checked' : '') : ''; ?> data-reload-qr-code>
                        ...
                        <li data-toggle="" data-placement="bottom" title="ficon8">
                            <input type="checkbox" id="ficon8" name="ficon8" <?php echo (!empty($filledInput)) ? (($filledInput['ficon8']) ? 'checked' : '') : ''; ?> data-reload-qr-code>
                        ...
                        <li data-toggle="" data-placement="bottom" title="ficon9">
                            <input type="checkbox" id="ficon9" name="ficon9" <?php echo (!empty($filledInput)) ? (($filledInput['ficon9']) ? 'checked' : '') : ''; ?> data-reload-qr-code>
                        ...
                        <li data-toggle="" data-placement="bottom" title="ficon10">
                            <input type="checkbox" id="ficon10" name="ficon10" <?php echo (!empty($filledInput)) ? (($filledInput['ficon10']) ? 'checked' : '') : ''; ?> data-reload-qr-code>
                        ...
                        <li data-toggle="" data-placement="bottom" title="ficon11">
                            <input type="checkbox" id="ficon11" name="ficon11" <?php echo (!empty($filledInput)) ? (($filledInput['ficon11']) ? 'checked' : '') : ''; ?> data-reload-qr-code>
                        ...
                        <li data-toggle="" data-placement="bottom" title="ficon12">
                            <input type="checkbox" id="ficon12" name="ficon12" <?php echo (!empty($filledInput)) ? (($filledInput['ficon12']) ? 'checked' : '') : ''; ?> data-reload-qr-code>
            ...
            <div class="collapseInner">
                <div class="row">
                    <div class="form-group col-6 pr-2">
                        ...
                        <input id="contactName" onchange="LoadPreview()" name="contactName" class="form-control" value="<?php echo (!empty($filledInput)) ? $filledInput['contactName'] : ''; ?>" maxlength="<?= $data->qr_code_settings['type']['menu']['companyTitle']['max_length'] ?>" data-reload-qr-code />
                    </div>
                    <div class="form-group col-6 pl-2">
                        <label for="contactWebsite"> <?= l('qr_codes.input.website') ?></label>
                        <input id="contactWebsite" onchange="LoadPreview()" name="contactWebsite" class="form-control" value="<?php echo (!empty($filledInput)) ? $filledInput['contactWebsite'] : ''; ?>" maxlength="<?= $data->qr_code_settings['type']['menu']['companyTitle']['max_length'] ?>" data-reload-qr-code />
                    </div>
                </div>
                <div>
                    <div class=" mb-3 addBusinessButton addRow" id="phn-block">
                        <?php foreach ($filledInput['contactMobileTitles'] as $key => $val) { ?>
                            <div class="form-group m-0">
                                <label for="contactMobiles">Telephone</label>
                                <div class="d-flex align-items-center w-100">
                                    <div class="d-flex align-items-center w-100">
                                        <input class="form-control mr-3" type="text" id="contactMobileTitles" onchange="LoadPreview()" name="contactMobileTitles[]" placeholder="Phone title" value="<?php echo $val ?>" data-reload-qr-code="">
                                        <input class="form-control mr-3" type="tel" id="contactMobiles" name="contactMobiles[]" onchange="LoadPreview()" placeholder="E.g. 00000 00000" value="<?php echo $filledInput['contactMobiles'][$key] ?>" data-reload-qr-code="">
                                    </div>
                ...
                <div>
                    <div class=" mb-3 addBusinessButton addRow" id="email-block">
                        <?php foreach ($filledInput['contactMobileTitles'] as $key => $val) { ?>
                            <div class="form-group m-0" id="email<?php echo $key + 1 ?>">
                                <label for="contactEmails">Email address</label>
                                <div class="d-flex align-items-center w-100">
                                    <div class="d-flex align-items-center w-100">
                                        <input class="form-control mr-3" type="text" id="contactEmailTitles" onchange="LoadPreview()" name="contactEmailTitles[]" value="<?php echo $val; ?>" placeholder="Label...">
                                        <input class="form-control mr-3" type="email" id="contactEmails" onchange="LoadPreview()" name="contactEmails[]" value="<?php echo $filledInput['contactEmails'][$key] ?>" placeholder="E.g. name@email.com">
                                    </div>
                    ...
                    <div class="row">
                        <div class="form-group m-0 col-md-6 col-sm-12">
                            ...
                            <select name="search_by" id="filters_title_by" class="form-control" onchange="LoadPreview()">
                                <option value="Lato" <?php echo (!empty($filledInput)) ? (($filledInput['search_by'] == 'Lato') ? 'selected' : '') : ''; ?>>Lato</option>
                                <option value="Open Sans" <?php echo (!empty($filledInput)) ? (($filledInput['search_by'] == 'Open Sans') ? 'selected' : '') : ''; ?>>Open Sans</option>
                                <option value="Roboto" <?php echo (!empty($filledInput)) ? (($filledInput['search_by'] == 'Roboto') ? 'selected' : '') : ''; ?>>Roboto</option>
                                <option value="Oswald" <?php echo (!empty($filledInput)) ? (($filledInput['search_by'] == 'Oswald') ? 'selected' : '') : ''; ?>>Oswald</option>
                                <option value="Montserrat" <?php echo (!empty($filledInput)) ? (($filledInput['search_by'] == 'Montserrat') ? 'selected' : '') : ''; ?>>Montserrat</option>
                                <option value="Source Sans Pro" <?php echo (!empty($filledInput)) ? (($filledInput['search_by'] == 'Source Sans Pro') ? 'selected' : '') : ''; ?>>Source Sans Pro</option>
                                <option value="Slabo 27px" <?php echo (!empty($filledInput)) ? (($filledInput['search_by'] == 'Slabo 27px') ? 'selected' : '') : ''; ?>>Slabo 27px</option>
                                <option value="Raleway" <?php echo (!empty($filledInput)) ? (($filledInput['search_by'] == 'Raleway') ? 'selected' : '') : ''; ?>>Raleway</option>
                                <option value="Merriwealther" <?php echo (!empty($filledInput)) ? (($filledInput['search_by'] == 'Merriwealther') ? 'selected' : '') : ''; ?>>Merriwealther</option>
                                <option value="Noto Sans" <?php echo (!empty($filledInput)) ? (($filledInput['search_by'] == 'Noto Sans') ? 'selected' : '') : ''; ?>>Noto Sans</option>
                            </select>
                        </div>
                        <div class="form-group m-0 col-md-6 col-sm-12">
    ...
    <div class="custom-accodian">
        ...
        <div class="collapse show" id="acc_aboutCompany">
            <div class="collapseInner">
                <div class="form-group m-0">
                    <textarea id="aboutCompany" name="aboutCompany" onchange="LoadPreview()" placeholder="E.g. Lorem ipsum" class="form-control textarea-control"><?php echo $filledInput['aboutCompany'] ?></textarea>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="collapse show" id="acc_nameOfQrCode">
            <div class="collapseInner">
                <div class="form-group m-0">
                    ...
                    <input id="name" name="name" placeholder="E.g. My QR code" class="form-control" value="<?php echo (!empty($filledInput)) ? $filledInput['name'] : ''; ?>" maxlength="<?= $data->qr_code_settings['type']['business']['name']['max_length'] ?>" data-reload-qr-code />
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function LoadPreview(welcome_screen = false) {
        ...
        if(companyLogoUrl == '' && company == '' && companyTitle == '' && companySubtitle == '' && businessButtons == ''){
            companyLogoUrl = '<?php echo LANDING_PAGE_URL;?>business.webp';
            company = 'Specialty coffee';
            companyTitle = 'Special Coffee';
            companySubtitle = 'Natural, artisan and local coffee. Open from Tuesday to Sunday from 8:00 am to 7:00 pm. Barista courses are held on Mondays.';
            businessButtons = 'ONLINE ORDER';
        }
