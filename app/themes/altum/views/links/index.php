    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-xl-auto d-flex">
            <div>
                ...
                <?php else: ?>
                    <a href="<?= url('link-create') ?>" class="btn btn-outline-primary cclr">
                        <i class="fa fa-fw fa-sm fa-plus"></i> <?= l('links.create') ?>
                    </a>
                <?php endif ?>
            </div>
            ...
            <div class="ml-3">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right d-print-none borr">
                    ...
                    <div class="dropdown-menu dropdown-menu-right filters-dropdown borr">
                        ...
                        <form action="" method="get" role="form">
                            <div class="form-group px-4">
                                ...
                                <input type="search" name="search" id="filters_search" class="form-control form-control-sm brr" value="<?= $data->filters->search ?>" />
                            </div>

                            <div class="form-group px-4">
                                <label for="filters_search_by" class="small"><?= l('global.filters.search_by') ?></label>
                                <select name="search_by" id="filters_search_by" class="form-control form-control-sm brr">
                            ...
                            <div class="form-group px-4">
                                ...
                                <select name="is_enabled" id="filters_is_enabled" class="form-control form-control-sm brr">
                            ...
                            <div class="form-group px-4">
                                ...
                                <select name="project_id" id="filters_project_id" class="form-control form-control-sm brr">
                                    <option value=""><?= l('global.filters.all') ?></option>
                            ...
                            <div class="form-group px-4">
                                ...
                                <select name="order_by" id="filters_order_by" class="form-control form-control-sm brr">
                            ...
                            <div class="form-group px-4">
                                ...
                                <select name="order_type" id="filters_order_type" class="form-control form-control-sm brr">
                            ...
                            <div class="form-group px-4">
                                ...
                                <select name="results_per_page" id="filters_results_per_page" class="form-control form-control-sm brr">
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <a href="<?= url('link-statistics/' . $row->link_id) ?>" class="btn btn-link text-decoration-none" data-toggle="tooltip" title="<?= l('link_statistics.pageviews') ?>">
                                <i class="fa fa-fw fa-chart-bar mr-1"></i> <?= nr($row->pageviews) ?>
                            </a>
                        </td>
        ...
        <div class="card borr">
            <div class="card-body">
                <div class="d-flex flex-column align-items-center justify-content-center py-3">
                    <img src="<?= ASSETS_FULL_URL . 'images/no_rows.svg' ?>" class="col-10 col-md-7 col-lg-4 mb-3 img-fluid no-rows-img" alt="<?= l('links.no_data') ?>" />
