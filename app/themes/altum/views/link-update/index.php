...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="custom-breadcrumbs small">
            <li>
                <a class="clrb" href="<?= url('links') ?>"><?= l('links.breadcrumb') ?></a><i class="fa fa-fw fa-angle-right"></i>
            </li>
    ...
    <p>
        <a class="clrb" href="<?= $data->link->full_url ?>" target="_blank">
        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="url" id="location_url" name="location_url" class="form-control brr <?= \Altum\Alerts::has_field_errors('location_url') ? 'is-invalid' : null ?>" value="<?= $data->link->location_url ?>" maxlength="2048" required="required" />
                    ...
                    <div class="form-group">
                        ...
                        <select id="domain_id" name="domain_id" class="form-control">
                            ...
                            <?php foreach($data->domains as $row): ?>
                                <option value="<?= $row->domain_id ?>" <?= $data->link->domain_id && $data->link->domain_id == $row->domain_id ? 'selected="selected"' : null ?>><?= $row->url ?></option>
                            <?php endforeach ?>
                        </select>
                    </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text brr"><?= SITE_URL ?></span>
                                    </div>
                                    <input type="text" id="url" name="url" class="form-control brr <?= \Altum\Alerts::has_field_errors('url') ? 'is-invalid' : null ?>" value="<?= $data->link->url ?>" onchange="update_this_value(this, get_slug)" onkeyup="update_this_value(this, get_slug)" placeholder="<?= l('links.input.url_placeholder') ?>" />
                                    <?= \Altum\Alerts::output_field_error('url') ?>
                                </div>
                                <?php if($data->linked_qr_codes): ?>
                                    <div><small class="text-warning" role="alert"><i class="fa fa-fw fa-exclamation-triangle mr-1"></i> <?= l('links.input.url_warning_linked_qr_code') ?></small></div>
                ...
                <button class="btn btn-block btn-gray-200 my-4 cclr" type="button" data-toggle="collapse" data-target="#pixels_container" aria-expanded="false" aria-controls="pixels_container">
                ...
                <button class="btn btn-block btn-gray-200 my-4 cclr <?= \Altum\Alerts::has_field_errors(['expiration_url']) ? 'border-danger' : null ?>" type="button" data-toggle="collapse" data-target="#temporary_url_container" aria-expanded="false" aria-controls="temporary_url_container">
                ...
                <div class="collapse" id="temporary_url_container">
                    ...
                    <div class="form-group">
                        ...
                        <input id="pageviews_limit" type="number" class="form-control brr" name="pageviews_limit" value="<?= $data->link->settings->pageviews_limit ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <input id="expiration_url" type="url" class="form-control brr <?= \Altum\Alerts::has_field_errors('expiration_url') ? 'is-invalid' : null ?>" name="expiration_url" value="<?= $data->link->settings->expiration_url ?>" maxlength="2048" />
                        <?= \Altum\Alerts::output_field_error('expiration_url') ?>
                        <small class="form-text text-muted"><?= l('links.input.expiration_url_help') ?></small>
                    </div>
                </div>

                <button class="btn btn-block btn-gray-200 my-4 cclr <?= \Altum\Alerts::has_field_errors(['targeting_*']) ? 'border-danger' : null ?>" type="button" data-toggle="collapse" data-target="#targeting_container" aria-expanded="false" aria-controls="targeting_container">
                ...
                <div class="collapse" id="targeting_container">
                    <div class="form-group">
                        ...
                        <select id="targeting_type" name="targeting_type" class="form-control brr">
                ...
                <button class="btn btn-block btn-gray-200 my-4 cclr" type="button" data-toggle="collapse" data-target="#protection_container" aria-expanded="false" aria-controls="protection_container">
                    <i class="fa fa-fw fa-user-shield fa-sm mr-1"></i> <?= l('links.input.protection') ?>
                </button>
                ...
                <div class="collapse" id="protection_container">
                    <div <?= $this->user->plan_settings->password_protection_is_enabled ? null : 'data-toggle="tooltip" title="' . l('global.info_message.plan_feature_no_access') . '"' ?>>
                        <div class="form-group <?= $this->user->plan_settings->password_protection_is_enabled ? null : 'container-disabled' ?>">
                            ...
                            <input type="password" id="password" name="password" class="form-control brr" value="<?= $data->link->settings->password ?>" autocomplete="new-password" />
                        </div>
                    </div>
                ...
                <button class="btn btn-block btn-gray-200 my-4 cclr" type="button" data-toggle="collapse" data-target="#advanced_container" aria-expanded="false" aria-controls="advanced_container">
