...
<div class="mb-5 row justify-content-between">
    ...
    <div class="col-12 col-sm-6 col-xl-3 mb-4 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-folder mr-1"></i> <?= l('admin_projects.menu') ?></small>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-end">
                            <?= include_view(THEME_PATH . 'views/admin/users/admin_user_dropdown_button.php', ['id' => $row->user_id, 'referral_key' => $row->referral_key,'type' => $row->type, 'resource_name' => $row->name]) ?>
                        </div>
                    </td>
                </tr>
            <?php endwhile ?>
        ...
        <div class="mb-5">
            ...
            <div class="table-responsive table-custom-container">
                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        <div class="d-flex flex-column">                            
                            <div>
                                <span class="text-muted">Payment Id - <?= $row->payment_id ?></span>                               
                                <br><span style="color:red">Payment Failed</span>                                
                            </div>
                        </div>
                    </td>
                    <td class="text-nowrap">
                    ...
                    <td class="text-nowrap">
                        <div class="d-flex flex-column">
                            <span style="color:red">$<?= nr($row->total_amount, 2)  ?></span>
            ...
            <?php else : ?>                    
                <tr>
                    ...
                    <td class="text-nowrap">
                        <div class="d-flex flex-column">
                            <span><?= ucfirst($row->type) ?><?= $row->is_refund?'<span style="color:red"> (Refunded)</span> ':''  ?> </span>
                            <div>
                                <span class="text-muted">Payment Id - <?= $row->payment_id ?></span>
                                <?php if($row->is_refund): ?>
                                    <br><span class="text-muted">Refund Id - <?= $row->refund_id ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </td>
