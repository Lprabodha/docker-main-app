...
<section class="admin-sidebar">
    ...
    <ul class="admin-sidebar-links">
        ...
        <?php if ($user->type != 3) : ?>
            <li class="<?= in_array(\Altum\Routing\Router::$controller, ['AdminBillings']) ? 'active' : null ?> d-none">
                <a class="nav-link d-flex flex-row" href="<?= url('admin/billings') ?>">
                    <div class="col-1 d-flex align-items-center"><i class="fa fa-fw fa-sm fa-box-open"></i></div>
                    <div class="col">
                        <span class="d-inline"><?= l('admin_billings.menu') ?></span>
                    </div>
                </a>
            </li>
        <?php endif ?>
        ...
        <?php if ($user->type != 3) : ?>
            <li class="<?= in_array(\Altum\Routing\Router::$controller, ['AdminStaticblocks']) ? 'active' : null ?> d-none">
                <a class="nav-link d-flex flex-row" href="<?= url('admin/staticblocks') ?>">
                    <div class="col-1 d-flex align-items-center"><i class="fa fa-fw fa-sm fa-box-open"></i></div>
                    <div class="col">
                        <span class="d-inline"><?= l('admin_staticblocks.menu') ?></span>
                    </div>
                </a>
            </li>
        <?php endif ?>
            ...
            <li class="<?= in_array(\Altum\Routing\Router::$controller, ['AdminArchivedQrCodes']) ? 'active' : null ?>">
                <a class="nav-link d-flex flex-row" href="<?= url('admin/archived-qr-codes') ?>">
                    <div class="col-1 d-flex align-items-center"><i class="fa fa-fw fa-sm fa-qrcode"></i></div>
                    <div class="col">
                        <span class="d-inline"><?= l('admin_archived_qr_codes.menu') ?> </span>
                    </div>
                </a>
            </li>       

        <?php if ($user->type != 3) : ?>
            <li class="<?= in_array(\Altum\Routing\Router::$controller, ['AdminLinks']) ? 'active' : null ?> d-none">
        ...
        <li class="<?= in_array(\Altum\Routing\Router::$controller, ['AdminProjects']) ? 'active' : null ?> d-none">
            <a class="nav-link d-flex flex-row" href="<?= url('admin/projects') ?>">
                <div class="col-1 d-flex align-items-center"><i class="fa fa-fw fa-sm fa-folder"></i></div>
                <div class="col">
        ...
        <?php if ($user->type != 3) : ?>
            <li class="<?= in_array(\Altum\Routing\Router::$controller, ['AdminPixels']) ? 'active' : null ?> d-none">
        ...
        <?php if ($user->type != 3) : ?>
            <li class="<?= in_array(\Altum\Routing\Router::$controller, ['AdminDomains', 'AdminDomainCreate', 'AdminDomainUpdate']) ? 'active' : null ?> d-none">
        ...
        <?php if ($user->type != 3) : ?>
            <?php if (\Altum\Plugin::is_active('teams')) : ?>
                <li class="<?= \Altum\Routing\Router::$controller == 'AdminTeams' ? 'active' : null ?> d-none">
        ...
        <?php if ($user->type != 3) : ?>
            <li class="<?= in_array(\Altum\Routing\Router::$controller, ['AdminPages', 'AdminPageCreate', 'AdminPageUpdate', 'AdminPagesCategories', 'AdminPagesCategoryCreate', 'AdminPagesCategoryUpdate']) ? 'active' : null ?> d-none" >
        ...
        <?php if ($user->type != 3) : ?>
            <div id="admin_sidebar_resources_container" class="collapse bg-gray-200 <?= in_array(\Altum\Routing\Router::$controller, ['AdminPages', 'AdminPageCreate', 'AdminPageUpdate', 'AdminPagesCategories', 'AdminPagesCategoryCreate', 'AdminPagesCategoryUpdate']) ? 'show' : null ?> d-none">
                ...
                <li class="<?= in_array(\Altum\Routing\Router::$controller, ['AdminPages', 'AdminPageCreate', 'AdminPageUpdate']) ? 'active' : null ?> d-none">
        ...
        <?php if ($user->type != 3) : ?>
            <li class="<?= in_array(\Altum\Routing\Router::$controller, ['AdminBlogPosts', 'AdminBlogPostCreate', 'AdminBlogPostUpdate', 'AdminBlogPostsCategories', 'AdminBlogPostsCategoryCreate', 'AdminBlogPostsCategoryUpdate']) ? 'active' : null ?> d-none">
        ...
        <?php if ($user->type != 3) : ?>
            <div id="admin_sidebar_blog_container" class="collapse bg-gray-200 <?= in_array(\Altum\Routing\Router::$controller, ['AdminBlogPosts', 'AdminBlogPostCreate', 'AdminBlogPostUpdate', 'AdminBlogPostsCategories', 'AdminBlogPostsCategoryCreate', 'AdminBlogPostsCategoryUpdate']) ? 'show' : null ?> d-none">
                ...
                <li class="<?= in_array(\Altum\Routing\Router::$controller, ['AdminBlogPosts', 'AdminBlogPostCreate', 'AdminBlogPostUpdate']) ? 'active' : null ?> d-none">
        ...
        <?php if (in_array(settings()->license->type, ['Extended License', 'extended'])) : ?>
            <?php if ($user->type != 3) : ?>
                <li class="<?= in_array(\Altum\Routing\Router::$controller, ['AdminCodes', 'AdminCodeCreate', 'AdminCodeUpdate']) ? 'active' : null ?> d-none">
                ...
                <li class="<?= in_array(\Altum\Routing\Router::$controller, ['AdminTaxes', 'AdminTaxCreate', 'AdminTaxUpdate']) ? 'active' : null ?> d-none">
            ...
            <?php if ($user->type != 3) : ?>
                <?php if (\Altum\Plugin::is_active('affiliate')) : ?>
                    <li class="<?= \Altum\Routing\Router::$controller == 'AdminAffiliatesWithdrawals' ? 'active' : null ?> d-none">
        ...
        <?php if ($user->type != 3) : ?>
            <li class="<?= \Altum\Routing\Router::$controller == 'AdminStatistics' ? 'active' : null ?> d-none">
        ...
        <?php if ($user->type != 3) : ?>
            <li class="<?= \Altum\Routing\Router::$controller == 'AdminApiDocumentation' ? 'active' : null ?> d-none">
        ...
        <?php if ($user->type != 3) : ?>
            <li class="<?= \Altum\Routing\Router::$controller == 'AdminPlugins' ? 'active' : null ?> d-none">
