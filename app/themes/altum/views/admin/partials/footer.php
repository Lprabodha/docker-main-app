...
<footer class="mt-5 d-flex flex-column flex-lg-row justify-content-between">
    <div class="mb-3 mb-lg-0">
        ...
        <!-- <div>Powered by <img src="<?= ASSETS_FULL_URL . 'images/altumcode.png' ?>" class="icon-favicon" alt="AltumCode logo" /> <a href="https://altumcode.com/" target="_blank">QR.new</a>.</div> -->
    </div>
