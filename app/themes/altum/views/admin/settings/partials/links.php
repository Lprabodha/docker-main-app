...
<div>
    <div class="form-group">
        <label for="qr_code_reader_is_enabled"><?= l('admin_settings.links.qr_code_reader_is_enabled') ?></label>
        <select id="qr_code_reader_is_enabled" name="qr_code_reader_is_enabled" class="form-control form-control-lg">
            <option value="1" <?= settings()->links->qr_code_reader_is_enabled ? 'selected="selected"' : null ?>><?= l('global.yes') ?></option>
            <option value="0" <?= !settings()->links->qr_code_reader_is_enabled ? 'selected="selected"' : null ?>><?= l('global.no') ?></option>
        </select>
    </div>
